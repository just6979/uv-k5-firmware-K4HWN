...
ENABLE_FEAT_JW_UPDOWN_REVERSE   ?= 1
ENABLE_FEAT_JW_MENU_MATCH       ?= 1
...
ifeq ($(ENABLE_FEAT_JW_UPDOWN_REVERSE),1)
    CFLAGS += -DENABLE_FEAT_JW_UPDOWN_REVERSE
endif

ifeq ($(ENABLE_FEAT_JW_MENU_MATCH),1)
    CFLAGS += -DENABLE_FEAT_JW_MENU_MATCH
endif
